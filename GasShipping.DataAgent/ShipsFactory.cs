...
{
    /// <summary>This class will be responsible for creating ships from the file agent</summary>
    public class ShipsFactory
    {
        /// <summary>list of ship objects</summary>
        public List<Ship> Ships { get; set; }
        /// <summary>FileAgent object</summary>
        private FileAgent _fileAgent;


        /// <summary>Initializes a new instance of the <see cref="ShipsFactory" /> class.</summary>
        ...
        /// <summary>This method converts List of ships to JSON string</summary>
        ...
        /// <summary>This method converts JSON string to List of ships</summary>
        ...
        /// <summary>This method will add a ship to the List&lt;Ship&gt;</summary>
        /// <param name="ship">Ship</param>
        public void AddShip(Ship ship ) => Ships.Add(ship);
        /// <summary>This method will remove the ship from the List&lt;Ship&gt;</summary>
        /// <param name="ship">Ship</param>
        /// <exception cref="ArgumentNullException">if the ship is null</exception>
        ...
        /// <summary>This method will read a JSON file then will convert it to list of ships</summary>
        /// <returns>List&lt;Ship&gt;</returns>
